...
<center><p class="list-group-item list-group-item-info"><b>PRODUCT DETAILS</b></p></center>
   ...
   <li class="list-group-item"><b>Product Code</b><span class="badge badge-warning float-right">'.$row->product.'</span></li>
  ...
  <li class="list-group-item"><b>Service Type</b><span class="badge badge-secondary float-right">'.$row->servicetype.'</span></li>
  <li class="list-group-item"><b>Additional Fee</b><span class="badge badge-danger float-right">'.$row->additionalfee.'</span></li>
